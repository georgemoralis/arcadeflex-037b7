...
public class karnov {
     ...
     *
     * Karnov has two 1024x8 palette PROM. I don't know the exact values of the
     ...
     **************************************************************************
     */
    public static VhConvertColorPromPtr karnov_vh_convert_color_prom = new VhConvertColorPromPtr() {
     ...
     * ***************************************************************************
     */
    public static VhUpdatePtr karnov_vh_screenrefresh = new VhUpdatePtr() {
    ...
    public static VhUpdatePtr wndrplnt_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int my, mx, offs, color, tile;
            int scrollx = karnov_scroll_1.READ_WORD(0);
            int scrolly = karnov_scroll_2.READ_WORD(0);
     ...
     * ***************************************************************************
     */
    public static WriteHandlerPtr karnov_foreground_w = new WriteHandlerPtr() {
     ...
     * ***************************************************************************
     */
    public static VhStopPtr karnov_vh_stop = new VhStopPtr() {
        public void handler() {
            if (dirty_f != null) {
                dirty_f = null;
            }
            if (karnov_foreground != null) {
                karnov_foreground = null;
            }
            if (bitmap_f != null) {
    ...
    public static VhStartPtr karnov_vh_start = new VhStartPtr() {
        public int handler() {
            /* Allocate bitmaps */
